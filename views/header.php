...
if (isset($_SESSION["id"])) {
  ...
  $myAccountLI = '<li class="nav-item"><a class="nav-link" style="color: white" href="./views/profil.php?id=' . $_SESSION["id"] . '">Mon compte</a></li>';
  ...
  if ($resulrole == 1) {
    $addproduit = '<li class="nav-item"><a id="produit_menu" class="nav-link" style="color: white" href="./views/produit.php">Ajouter un produit</a></li>';
  } else {
    $addproduit = "";
  }
} else {
...
<body>
  <header>
    <div class="container-fluid">
      <div class="row">
        <a href="./index.php"><img class="col-xs=2 col-sm=2 col-md-2" id="logo_jarditou" src="./assets/img/index_logo.jpg" alt="logo de index"></a>

        <h3 class="col-xs=10 col-sm=12 col-md-2"><strong><?php if (isset($_SESSION["id"])) {
                                    echo "Bienvenue " . $usersinfo["identifiant"];
                                  } ?>
      </div>
          ...
          <nav class="col-12 navbar navbar-expand-lg navbar-light bg">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
              ...
              <ul class="navbar-nav mr-auto mt-2 mt-lg-0-">
                ...
                <li class="nav-item">
                  <a id="table_menu" class="nav-link" href="./views/table.php">Nos produits</a>
                </li>

                <li class="nav-item">
                  <a class="nav-link" style="color: white" href="./views/connect.php">Connexion</a></li>

                <li class="nav-item">
                  <a id="table_menu" class="nav-link" href="./controllers/deconnection.php">Deconnexion</a></li>
